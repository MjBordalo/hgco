...
/* Generated from ../O.Common/topExemplo.dbd */
...
int topExemplo_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/pi/EPICS_apps/miguelExample";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"topExemplo_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    topExemplo_registerRecordDeviceDriver(*iocshPpdbbase);
}
