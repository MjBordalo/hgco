...
/* Generated from ../O.Common/GreenHouse.dbd */
...
int GreenHouse_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/pi/hgco/EPICS_apps/GreenHouse_top";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"GreenHouse_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    GreenHouse_registerRecordDeviceDriver(*iocshPpdbbase);
}
